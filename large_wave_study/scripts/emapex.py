...
emapex_data = _os.path.expanduser('~/data/DIMES/EM-APEX')
processed = _os.path.expanduser('~/data/processed')
...
def find_file(floatID, data_dir=emapex_data):
...
def load(floatID, data_dir=emapex_data,
         pp_dir=processed, apply_w=True,
...
def load_DIMES(data_dir=emapex_data, pp_dir=processed,
